...
// const PortfolioItem = () => {
//   <ModalImage
//   small="https://example.com/my-thumbnail-image.jpg"
//   large="https://example.com/my-original-image.jpg"
//   alt="My image"
// />

//   const images = [
//     {
//       url: 'https://www.themetechmount.com/wordpress/wilddale/wp-content/uploads/2021/07/post-15.jpg',
//       title: 'White Duck',
//     },
//   ];

//   return (
//     <div className="tm-box-col-wrapper mamalds slick-slide slick-active" tabIndex="-1" role="option" aria-describedby="slick-slide13" style={{ width: '572px' }} data-slick-index="3" aria-hidden="false">
//       <article className="themetechmount-box themetechmount-box-portfolio themetechmount-portfoliobox-style1  tm-post-format-image">
//         <div className="themetechmount-post-item">
//           <div className="themetechmount-post-item-inner">
//             <span className="themetechmount-item-thumbnail">
//               <span className="themetechmount-item-thumbnail-inner">
//                 <img width="740" height="800" src="https://sp-ao.shortpixel.ai/client/to_webp,q_glossy,ret_img,w_740,h_800/https://www.themetechmount.com/wordpress/wilddale/wp-content/uploads/2021/07/post-15-740x800.jpg" alt="" />
//               </span>
//             </span>
//           </div>
//           <div className="themetechmount-box-content themetechmount-overlay">
//             <div className="themetechmount-box-content-inner">
//               <div className="item-content-box tm-hide">
//                 <div className="themetechmount-box-title"><h4>White Duck</h4></div>
//               </div>
//               <div className="themetechmount-icon-box themetechmount-media-link">
//                 <a className="tm_prettyphoto" href={images[0].url} tabIndex="0" onClick={(e) => { e.preventDefault();  }}>
//                   <i className="tm-wilddale-icon-resize-full-alt"></i>
//                 </a>
//               </div>
//             </div>
//           </div>
...
//               <span className="themetechmount-item-thumbnail">
//                 <span className="themetechmount-item-thumbnail-inner">
//                   <ModalImage small="https://sp-ao.shortpixel.ai/client/to_webp,q_glossy,ret_img,w_740,h_800/https://www.themetechmount.com/wordpress/wilddale/wp-content/uploads/2021/07/post-13-740x800.jpg" large="https://www.themetechmount.com/wordpress/wilddale/wp-content/uploads/2021/07/post-15.jpg" alt="White Duck" hideDownload={true} hideZoom={true} className="attachment-themetechmount-img-portfolio size-themetechmount-img-portfolio wp-post-image" />
//                 </span>
//               </span>
//             </div>
//             <div className="themetechmount-box-content themetechmount-overlay">
...
//                 </div>
//                 <div className="themetechmount-icon-box themetechmount-media-link">
//                   <button onClick={() => setShowModal(true)}><i className="tm-wilddale-icon-resize-full-alt"></i></button>
//                 </div>
//               </div>
//             </div>
//           </div>
...
//           <img src="https://sp-ao.shortpixel.ai/client/to_webp,q_glossy,ret_img,w_740,h_800/https://www.themetechmount.com/wordpress/wilddale/wp-content/uploads/2021/07/post-13-740x800.jpg" alt="White Duck" />
//         </div>
//       }
//     </div>
//   );
